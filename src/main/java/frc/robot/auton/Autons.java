      ...
      new ParallelCommandGroup(
          new SequentialCommandGroup(
              ...
              new SwervePosController(
                      ...
                      (point, time) ->
                          getAngleToTarget(point.getTranslation(), Constants.HUB_LOCATION).minus(Rotation2d.fromDegrees(20)),
                      () -> Rotation2d.fromDegrees(136.97))
                  .deadlineWith(new IntakeAuton()),
              new WaitCommand(1),
              new ShooterAuton()),
          new SequentialCommandGroup(new ZeroHood(), new HoodManual()), new IndexerManual());
