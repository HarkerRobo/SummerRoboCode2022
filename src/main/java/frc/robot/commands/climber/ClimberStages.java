...
public class ClimberStages{
    ...
    public static final SequentialCommandGroup STAGE_1 = new SequentialCommandGroup(
                                                            new SetClimberPos(Climber.UP_HEIGHT),
                                                            new WaitForDriver(),
                                                            new SetClimberPos(Climber.DOWN_HEIGHT));

    public static final SequentialCommandGroup STAGE_2_AND_3 = new SequentialCommandGroup(
    ...
    public static final SequentialCommandGroup ALL_STAGES = new SequentialCommandGroup(
                                                                STAGE_1,
                                                                new WaitForDriver(),
                                                                STAGE_2_AND_3,
                                                                new WaitForDriver(),
