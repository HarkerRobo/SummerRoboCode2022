...
public class Trajectories {
  ...
  public static final Pose2d[] hAG = {
    ...
    new Pose2d(new Translation2d(1.67, 6.56), Rotation2d.fromDegrees(180)),
    new Pose2d(new Translation2d(1.85, 4.41), Rotation2d.fromDegrees(180)),
    new Pose2d(new Translation2d(4.03, 3.29), Rotation2d.fromDegrees(180)),
  ...
  public static final Pose2d[] hFFB = {
    ...
    new Pose2d(new Translation2d(1.82, 4.44), Rotation2d.fromDegrees(0)),
    new Pose2d(new Translation2d(2.22, 6.49), Rotation2d.fromDegrees(90)),
    new Pose2d(new Translation2d(5.54, 7.4), Rotation2d.fromDegrees(-13.73)),
    new Pose2d(new Translation2d(6.41, 5.82), Rotation2d.fromDegrees(51.71))
  };
